...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/lightingSummary")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/lighting/switches/{deviceId}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/ZachT1711/Zach/1.0.0/lighting/dimmers/{deviceId}/{value}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/ZachT1711/Zach/1.0.0/lighting/dimmers/{deviceId}/{value}/timer/{timeunit}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/ZachT1711/Zach/1.0.0/lighting/switches/{deviceId}/{value}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/ZachT1711/Zach/1.0.0/lighting/switches/{deviceId}/{value}/timer/{minutes}")]
        [ValidateModelState]
