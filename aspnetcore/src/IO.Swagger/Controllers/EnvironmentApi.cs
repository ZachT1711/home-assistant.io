...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/temperature/forecast/{days}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/temperature/{zoneId}/heater")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/temperature/{zoneId}")]
        [ValidateModelState]
        ...
        [HttpPost]
        [Route("/ZachT1711/Zach/1.0.0/temperature/{zoneId}/heater/{state}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/ZachT1711/Zach/1.0.0/temperature")]
        [ValidateModelState]
